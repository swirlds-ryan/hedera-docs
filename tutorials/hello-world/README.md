...
{% content-ref url="./hfs-files.md" %} . {% endcontent-ref %}

{% content-ref url="./hts-fungible-token.md" %} . {% endcontent-ref %}

{% content-ref url="./hscs-smart-contract.md" %} . {% endcontent-ref %}
